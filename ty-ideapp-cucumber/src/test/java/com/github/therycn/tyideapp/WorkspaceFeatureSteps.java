...
public class WorkspaceFeatureSteps {
	...
	public void i_ask_for_workspaces() {
		response = restTemplate.exchange(baseUri + "/workspaces/", HttpMethod.GET, new HttpEntity<Object>(headers),
	...
	public void i_ask_for_saving_workspace() {
		ResponseEntity<WorkspaceListItem> response = restTemplate.exchange(baseUri + "/workspaces/", HttpMethod.POST,
	...
	public void i_delete_the_selected_workspace() {
		restTemplate.exchange(baseUri + "/data-rest/workspaces/" + selectedWorkspaceId, HttpMethod.DELETE,
